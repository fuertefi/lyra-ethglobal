...
import { MAX_UINT, OptionType, toBN, ZERO_ADDRESS } from '@lyrafinance/protocol/dist/scripts/util/web3utils';
import { BasicFeeCounter__factory, ERC20__factory } from '@lyrafinance/protocol/dist/typechain-types';
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers';
import { expect } from 'chai';
import { ethers, network, upgrades } from 'hardhat';
import { HackMoneyVault, HackMoneyVault__factory } from '../../../typechain-types';
...
describe('Hack Money Vault integration test', async () => {
  ...
  it('deploy on kovan fork, deposit and try to trade', async () => {
      ...
      params: [
        {
          forking: {
            ...
            jsonRpcUrl: 'https://opt-mainnet.g.alchemy.com/v2/dW3_J05iOi-kuyk1Zgy7bwXip_gXMeSX',
    ...
    const sETH = ERC20__factory.connect('0xE405de8F52ba7559f9df3C368500B6E6ae6Cee49', deployer);
    // const sETH = new Contract(
    // lyraMarket.BaseAsset.address,
    // lyraMarket.BaseAsset.abi,
    // whale
    // ) as ERC20;
    const sUSD = ERC20__factory.connect('0x8c6f28f2F1A3C87F0f938b96d27520d9751ec8d9', deployer);
    ...
    await sETH.connect(whale).transfer(deployer.address, ethers.utils.parseEther('100'));
    ...
    const HackMoneyStrategy = await ethers.getContractFactory('HackMoneyStrategy', {
      libraries: {
        '@lyrafinance/protocol/contracts/libraries/BlackScholes.sol:BlackScholes':
          '0x409f9A1Ee61E94B91b11e3696DF2108EFc7C3EF5',
      },
