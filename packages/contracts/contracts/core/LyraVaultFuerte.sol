...
// import {IStrategyFuerte} from "../interfaces/IStrategyFuerte.sol";

// /// @notice LyraVault help users run option-selling strategies on Lyra AMM.
// contract LyraVaultFuerte is Ownable, BaseVault {
//   IERC20 public immutable premiumAsset;
//   IERC20 public immutable collateralAsset;

//   IStrategyFuerte public strategy;
...
//   event Trade(address user, uint callPositionId, uint putPositionId, uint premium, uint capitalUsed);
...
//     strategy = IStrategyFuerte(_strategy);
//     collateralAsset.approve(_strategy, type(uint).max);
//     emit StrategyUpdated(_strategy);
//   }

//   /// @dev anyone can trigger a trade
//   /// @param callStrikeId the strike id to sell
//   /// @param putStrikeId the strike id to sell
//   function trade(uint callStrikeId, uint putStrikeId) external {
//     require(vaultState.roundInProgress, "round closed");
//     // perform trade through strategy
//     //(uint positionId, uint premiumReceived, uint capitalUsed)
//     (uint callPositionId,
//       uint putPositionId,
//       uint premiumReceived,
//       uint callCollateral,
//       uint putCollateral) = strategy.doTrade(
//       callStrikeId,
//       putStrikeId,
//       lyraRewardRecipient
//     );
...
//     vaultState.lockedAmountLeft = vaultState.lockedAmountLeft - callCollateral - putCollateral;
